...
output_file = DB_FAISS_PATH + "/data_f_rerank_hyde.json"
# output_file = DB_FAISS_PATH + "/data_f_rerank4.json"
print(input_file)
...
for item in dataD:
    ...
    prediction = split_strings[-1]
    print(question)
    contexts =  [doc.page_content for doc in compression_retriever.get_relevant_documents(question)]
